    ...
    getModalForm: function (form, data, attrList,voucherNewType,timeNewType, disabled,labelWidths, layout) {
        ...
        var items = [
            <FormItem {...itemLayouts[3]} required key='voucherName' label='优惠券名称' colon={true} help={hints.voucherNameHint} validateStatus={hints.voucherNameStatus} className={layoutItem}>
                <Input type='text' name='voucherName' id='voucherName' value={data.voucherName}  {...attrMap.voucherName} onChange={form.handleOnChange} placeholder="请输入优惠券名称" disabled={disabled}/>
            </FormItem>,
            ...
            (voucherNewType== 'CONDITION_DECREASE'?<FormItem {...itemLayouts[3]} required className={layoutItem} label='满减设置'>
                <Input type='text' addonBefore="满" style={{ width: 314 }} addonAfter="元" name='satisfyConditionPrice' id='satisfyConditionPrice' value={data.satisfyConditionPrice} onChange={form.handleOnChange} placeholder='输入金额' disabled={disabled}/> <Input type='text' addonBefore="减" addonAfter="元" style={{ width: 314 }} name='conditionDecreasePrice' id='conditionDecreasePrice' value={data.conditionDecreasePrice} onChange={this.handleOnChange} placeholder='输入金额' disabled={disabled}/>
                ...
                <Input type='text' addonBefore="减" style={{ width: 314 }} addonAfter="元" name='instantDecreasePrice' id='instantDecreasePrice' value={data.instantDecreasePrice} onChange={form.handleOnChange}    placeholder='输入金额' disabled={disabled}/>
            </FormItem>),
            ...
            (timeNewType=='SECTION_TIMES'?<FormItem {...itemLayouts[3]} required key='validDate' label='有效日期' required={true} colon={true} help={hints.validDateHint} validateStatus={hints.validDateStatus}  className={layoutItem} >
                <RangePicker onChange={form.handleOnChange}  disabled={disabled}/>
                ...
                <Input type='text' required={true} addonAfter="天" style={{ width: 314 }} name='timeFixed' id='timeFixed' value={data.timeFixed} onChange={form.handleOnChange}    placeholder='输入天数' {...attrMap.time} disabled={disabled}/>
            </FormItem>)
        ];
