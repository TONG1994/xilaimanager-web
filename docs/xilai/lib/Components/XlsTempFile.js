...
module.exports = function ($thisBtn) {
    return {
        ...
        uploadXlsFile: function (url, data, cols, file, callback,$this) {
            var self = this;
